...
Visible project rules: frequent commits; public open-source repository; video
no longer than four minutes; sped-up videos disqualify. Other video rules must
be checked on the detailed rules before recording.
