...
| G1 | Repository history through `e757e91`, 9 September 2026 | Public implementation and revision evidence; commit timestamps alone do not determine human versus AI authorship. [Commit history](https://github.com/SergeySolovyev/icicpe-2026-event-time-mcdm-defi/commits/master/). |
