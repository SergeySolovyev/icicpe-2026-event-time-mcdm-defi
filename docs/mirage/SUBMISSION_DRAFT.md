...
Deployed and exercised on Ethereum Sepolia on 13 September 2026. [`MirageGate`](https://sepolia.etherscan.io/address/0xe1b9031EeF64e376c37B4e3E849B35424f647901) at `0xe1b9031EeF64e376c37B4e3E849B35424f647901`, [`ExecutionGuard`](https://sepolia.etherscan.io/address/0x17260e16672ABb8CAAe616F712997d59008F3034) at `0x17260e16672ABb8CAAe616F712997d59008F3034`. The contract read `latestRoundData()` itself and stored [`Allow` for 10,000 USDC](https://sepolia.etherscan.io/tx/0xb914cccc6f4f1c50681665d32b03f8f93c397584a344b19d9f29a99c82bedb6e) at a measured deviation of 12 bps, then [`Blocked` for 20,000](https://sepolia.etherscan.io/tx/0xcf67edbe968449713aa5bfe637ac1fecd65b07af1a4dca80e110735b9a946aa0) from the same evidence at the same block. `ExecutionGuard.enter` then [admitted the 10,000 entry](https://sepolia.etherscan.io/tx/0xb5520fa4a7343d2ebe5b38cb83234e480a56b173be527aa3d8111072044abdfb) and [refused the 20,000 one](https://sepolia.etherscan.io/tx/0xedc5b8abb3a1fa126cb3ab079aedb6bc9eafe02f717a176f871b8a4e5132d6a0), reverting `EntryNotAllowed` in block 11694947 — a failed transaction that is the point rather than a defect. Full record: [CHAINLINK_SEPOLIA_2026-09-13.json](CHAINLINK_SEPOLIA_2026-09-13.json).

One honest caveat for anyone reading the contract later: `isAllowed` returns false for both amounts once `maxDecisionAge` of 3600 seconds has passed. That expiry is deliberate — an admission decision should not outlive the evidence behind it — so the durable proof is the transactions above, not a live `true`.
