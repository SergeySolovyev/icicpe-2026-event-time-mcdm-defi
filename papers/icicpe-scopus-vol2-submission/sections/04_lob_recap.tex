...
A prior work \cite{solovev2026lob} proposed the DA-BiGRU-CNN
architecture for LOB mid-price prediction.  Two BiGRU branches
operate on price-series and
...
Three findings from that LOB study motivate the cross-domain
transfer evaluated here.  First, the dual-branch GRU on a compact set of 53
...
\midrule
DA-BiGRU-CNN         & 53  & $\LobGRUwPearson$  & --- \\
...
These findings constitute the baseline methodology now tested in a
