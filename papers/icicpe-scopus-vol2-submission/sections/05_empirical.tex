...
\paragraph{Scope and data provenance.}
The walk-forward matrix covers all six designed protocols on
Ethereum L1 USDC supply markets ($\sim\$36$\,B of \$54\,B
addressable TVL, $\sim 67\%$ of the design universe).  Per-protocol
